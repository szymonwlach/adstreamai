      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative">
            ...
            <button
              onClick={prevDemo}
              className="lg:hidden absolute left-2 sm:left-4 top-[50%] sm:top-[53%] z-20 p-3 sm:p-4 rounded-full bg-background/90 backdrop-blur-sm border-2 border-primary/30 hover:border-primary shadow-xl active:scale-95 transition-all"
              aria-label="Previous"
            >
            ...
            <button
              onClick={nextDemo}
              className="lg:hidden absolute right-2 sm:right-4 top-[50%] sm:top-[53%] z-20 p-3 sm:p-4 rounded-full bg-background/90 backdrop-blur-sm border-2 border-primary/30 hover:border-primary shadow-xl active:scale-95 transition-all"
              aria-label="Next"
            >
